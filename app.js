...
App({
  onLaunch: function() {
    if (typeof wx !== 'undefined' && wx.cloud) {
      wx.cloud.init({ traceUser: true, env: CONFIG.cloudEnvId || undefined })
    }
